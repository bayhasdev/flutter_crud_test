...
class Localeapp {
  ...
  String get news => _data["news"]!;
  String get articles => _data["articles"]!;
  String get choseForYou => _data["choseForYou"]!;
  String get tags => _data["tags"]!;
  String get relatedArticles => _data["relatedArticles"]!;
  String get mostReadArticles => _data["mostReadArticles"]!;
}
...
class Localemsg {
  ...
  String get resetPasswordLinkSendToEmail => _data["resetPasswordLinkSendToEmail"]!;
}
...
class LocaledateTime {
  ...
  String get daily => _data["daily"]!;
  String get monthly => _data["monthly"]!;
  String get weekly => _data["weekly"]!;
  String get yearly => _data["yearly"]!;
