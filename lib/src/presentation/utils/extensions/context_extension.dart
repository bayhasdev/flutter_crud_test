...
import '../../ui/ui_component/custom_widget/messages.dart';
...
extension AddSpaceExtension on BuildContext {
  ...
  double getRelativeWidth(double height, {double aspectRatio = 16 / 9}) => height / aspectRatio;
  double getRelativeHeight({double? width, double aspectRatio = 16 / 9}) {
...
extension NavigationExtension on BuildContext {
  ...
  Future<T?> pushNamedAndRemoveUntil<T>(String path, {String untilPath = MyApp.routeName, Object? data}) async {
