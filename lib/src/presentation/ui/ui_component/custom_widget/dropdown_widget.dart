...
class _DropDownWidgetState<T> extends State<DropDownWidget<T>> {
  ...
  Widget _buildDropdownButton() {
    return DropdownButton<T>(
      ...
      onTap: () => GlobalVar.log('DropdownButton on tap'),
...
class _DropdownWidgetqState extends State<DropdownWidgetq> {
  ...
  Widget _buildDropdownButton() {
    return DropdownButton<dynamic>(
      ...
      selectedItemBuilder: (context) {
        return localDataList.map<Widget>((e) => Text(e.toString(), style: const TextStyle(color: Colors.red))).toList();
      },
    );
  }
  ...
  Widget _singleItem(dynamic item, TextStyle? textStyle) {
    return Container(
      ...
      child: item == null
          ...
          : Text(widget.itemToString != null ? widget.itemToString!(item) : item.toString(), style: const TextStyle(color: Colors.amber)),
    );
  }
